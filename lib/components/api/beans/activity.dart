...
class ActivityInfoResp {
  ...
  factory ActivityInfoResp(jsonStr) => jsonStr == null ? null : jsonStr is String ? new ActivityInfoResp.fromJson(json.decode(jsonStr)) : new ActivityInfoResp.fromJson(jsonStr);
  
  ActivityInfoResp.fromJson(jsonRes) {
    code = jsonRes['code'];
    err = jsonRes['err'];
    errmsg = jsonRes['errmsg'];
    data = jsonRes['data'] == null ? null : new ActivityInfo.fromJson(jsonRes['data']);
  }
...
class ActivityInfo {
  ...
  List<ImgInfo> Imgs;
  List<dynamic> ProductAttrs;
  List<ImgInfo> ProductDescription;
  List<ActivityTemplate> Template;

  ActivityInfo.fromParams({this.Gift, this.InspectionReport, this.PriceRange, this.RecommendGroup, this.ActivityType, this.AssessNum, this.GroupBuyMinNum, this.GroupNum, this.MaxSingleBuyNum, this.NoAssessNum, this.UsersNum, this.Commission, this.GroupPrice, this.MarketPrice, this.MaxPrice, this.MinPrice, this.SingleBuyPrice, this.ActivityCode, this.BrandCode, this.BrandLogo, this.BrandName, this.CanSingleBuy, this.Category, this.IsCollection, this.IsFreeExpress, this.Name, this.ProductNo, this.RelationActivity, this.SellingPoints, this.StatusMsg, this.Video, this.Assess, this.GroupTeams, this.Imgs, this.ProductAttrs, this.ProductDescription, this.Template});
  ...
  ActivityInfo.fromJson(jsonRes) {
    ...
    for (var AssessItem in Assess == null ? [] : jsonRes['Assess']){
            Assess.add(AssessItem == null ? null : new ActivityAssess.fromJson(AssessItem));
    }

    GroupTeams = jsonRes['GroupTeams'] == null ? null : [];

    for (var GroupTeamsItem in GroupTeams == null ? [] : jsonRes['GroupTeams']){
    ...
    for (var ProductAttrsItem in ProductAttrs == null ? [] : jsonRes['ProductAttrs']){
            ProductAttrs.add(ProductAttrsItem);
    }

    ProductDescription = jsonRes['ProductDescription'] == null ? null : [];

    for (var ProductDescriptionItem in ProductDescription == null ? [] : jsonRes['ProductDescription']){
            ProductDescription.add(ProductDescriptionItem == null ? null : new ImgInfo.fromJson(ProductDescriptionItem));
    }

    Template = jsonRes['Template'] == null ? null : [];

    for (var TemplateItem in Template == null ? [] : jsonRes['Template']){
            Template.add(TemplateItem == null ? null : new ActivityTemplate.fromJson(TemplateItem));
    }
  }
...
class ActivityAssess {
  ...
  ActivityAssess.fromParams({this.Imgs, this.Pleased, this.Anonymous, this.AssessCode, this.Audit, this.Content, this.InsertTime, this.Ischoice, this.NickName, this.Portrait, this.ProductCode, this.ProductNo, this.SpacValue, this.UserPK});
...
class ActivityProductSKUResp {
  ...
  ActivityProductSKUResp.fromParams({this.code, this.err, this.errmsg, this.data});

  factory ActivityProductSKUResp(jsonStr) => jsonStr == null ? null : jsonStr is String ? new ActivityProductSKUResp.fromJson(json.decode(jsonStr)) : new ActivityProductSKUResp.fromJson(jsonStr);
  ...
  ActivityProductSKUResp.fromJson(jsonRes) {
    ...
    for (var dataItem in data == null ? [] : jsonRes['data']){
            data.add(dataItem == null ? null : new ActivityProductSKU.fromJson(dataItem));
    }
  }
...
class ActivityProductSKU {
  ...
  ActivityProductSKU.fromParams({this.Num, this.Store, this.Name, this.SkuID, this.SpacGroupName, this.Values});
  ...
  ActivityProductSKU.fromJson(jsonRes) {
    ...
    for (var ValuesItem in Values == null ? [] : jsonRes['Values']){
            Values.add(ValuesItem == null ? null : new ActivityProductSKU.fromJson(ValuesItem));
    }
  }
